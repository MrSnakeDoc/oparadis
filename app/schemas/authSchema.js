...
module.exports = {
	signup: Joi.object({
		email: Joi.string()
			...
			.error(
				new Error(
					"Example : Winnie.l.ourson@gmiel.com, domain authorized : com, net, fr, it, io"
				)
			),
		password: Joi.string()
			...
			.error(
				new Error(
					"Password must includes uppercase, lowercase, and these characters -_$@#!?"
				)
			),
